...
export const metadata = constructMetadata({
  title: 'O que fazer em São Roque | Lugares, Passeios e Experiências',
...
export default async function ExplorarPage({ searchParams }: ExplorarPageProps) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8 bg-[#FCFAF5]">
      
      {/* PAGE HEADER */}
      <div className="space-y-4 text-center md:text-left border-b border-[#e6dfd4] pb-6">
        <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-[#F4EBDD] text-[#183A32] text-xs font-semibold border border-[#e6dfd4]">
          ...
          <span>Guia Completo de São Roque</span>
        </div>
      ...
      <div className="flex flex-col lg:flex-row gap-8 items-start">
        ...
        {/* SIDEBAR FILTERS */}
        <FilterSidebar categories={categories} totalResults={businesses.length} />
