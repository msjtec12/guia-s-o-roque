...
export async function generateMetadata({ params }: BusinessPageProps) {
  ...
  return constructMetadata({
    title: `${business.name} | Descubra Cidades`,
    description: `${business.description.slice(0, 150)} no guia Descubra Cidades.`,
...
export default async function BusinessDetailPage({ params }: BusinessPageProps) {
  ...
  const jsonLd = {
    ...
    url: business.website || `https://descubra.tur.br/empresa/${business.slug}`,
    aggregateRating: {
