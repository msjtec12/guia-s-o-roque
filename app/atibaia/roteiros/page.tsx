...
export const metadata = constructMetadata({
  title: 'Roteiros em Atibaia | Monte seu Passeio',
  description: 'Confira roteiros turísticos prontos e personalizados em Atibaia: Pedra Grande, Rota do Morango, Família e Cervejeiro.',
  citySlug: 'atibaia',
});

export const revalidate = 60;

export default async function AtibaiaRoteirosPage() {
  const routes = await getRoutes('atibaia');
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-20 space-y-10 bg-[#F6F0D4]">
      ...
      <div className="space-y-3 text-center md:text-left border-b border-[#E7E5DF] pb-6">
        ...
        <p className="text-sm sm:text-base text-[#26332F]/80 max-w-3xl">
          Selecione um roteiro pronto ou crie um itinerário personalizado de acordo com o seu perfil e tempo disponível em Atibaia.
        </p>
      </div>
      ...
      <div className="rounded-3xl bg-[#071510] text-[#FFFFFF] p-8 border border-[#1B4931]/50 shadow-xl flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="space-y-2 text-center md:text-left">
          ...
          <h2 className="font-serif text-2xl font-bold text-[#FFFFFF]">
            ✨ Monte seu próprio roteiro personalizado em Atibaia
          </h2>
          <p className="text-xs sm:text-sm text-[#E7E5DF]">
            Responda a 3 perguntas rápidas e nosso sistema gera um cronograma sob medida com Pedra Grande, restaurantes e passeios.
          </p>
        </div>
        <Link
